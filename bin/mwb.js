...
function initMongo() {
  ...
  tmp.scripts.start = process.platform === 'win32' ? 'start /B mongod --dbpath db --bind_ip 127.0.0.1 && npm run clean && node tool/dev' // to stop this, has to use ctrl + break, NOT ctrl + c due to the use of start /B
